...
intro: Jefe de diseño, investigación, cocreación, diseño visual y de interacción para la creación de un neobanco en Andorra y creación de sistema de diseño.
...
![Rediseño de la posición global de Myandbank](../../assets/Myandbank1.png)
## Desafío
...
El banco se debía lanzar en un plazo de un año desde el inicio del proyecto y con las siguientes características:
...
![Sistema de diseño de Myandbank](../../assets/Myandbank2.png)
...
- Introducción de Bizum en Andorra: MyAndbank fue la primera entidad no española en introducir Bizum. Trabajamos mano a mano con Bizum en este hito poniendo especial atención al *onboarding* de una funcionalidad poco conocida por nuestros clientes.
...
![Posición global de Myandbank Junior](../../assets/Myandbank3.png)
...
- Creación de un producto escalable no solo creando y manteniendo el sistema de diseño, si no desarrollando una arquitectura de la información que haga que la introducción de nuevas características no redunde en una mayor complejidad para el cliente.