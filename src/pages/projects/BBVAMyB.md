...
client: BBVA
rol: Diseñador de interacción y jefe de proyecto
year: 2022
link: https://www.bbva.es/finanzas-vistazo/ef/ahorro/programa-tu-cuenta.html
intro: Diseño de interacción y diseño visual de la automatización de tareas para clientes particulares de BBVA y de las notificaciones de los hechos más relevantes para los usuarios en relación con sus finanzas.

---
## Objetivos
1. Descubrir los principales desafíos a los que se enfrenta una pyme en su día a día.
2. Ver en que áreas puede aportar valor el banco a las empresas.
3. Crear un nuevo producto que ayude a las pymes en su actividad diaria.

![Entrevistas en comercios para conocer sus necesidades](../../assets/MB2.png)
## Desafio
...
![Presentación de resultados de la investigación](../../assets/MB3.png)

## Desarrollo del proyecto

Una vez definidos los objetivos de este proyecto, definimos junto con BBVA el público objetivo para lanzar una investigación cualitativa.
...
En la primera, mediante un proceso de convergencia-divergencia, extrajimos todas las posibles funcionalidades que podían aportar valor a este tipo de usuarios apoyándonos en los resultados de la investigación.
...
![Sesión de cocreación](../../assets/MB4.png)
...
![Prototipo navegable del MVP](../../assets/MB1.png)